...
class ShopInventory extends ShopHome
{
	public static function Main()
	{
		...
		// Sub-menu tabs
		$context['inventory_tabs'] = self::Tabs();
		// Item images...
	...
	public static function Count($memid, $cat = null)
	{
		global $smcFunc;
	...
	public static function Get($start, $items_per_page, $sort, $memid, $cat = null)
	{
	...
	public static function Profile($profile = array())
	{

...
class AdminShopCategories extends AdminShop
{
		...
		$listOptions = array(
			...
			'columns' => array(
				...
				'items_in' => array(
						...
						'data' => array(
							'function' => function($row){ return parent::categoriesItemsCount($row['catid']);},
							'style' => 'width: 3%',
							'class' => 'centertext',
						),
					),
	...
	public static function Delete2()
	{
		...
		if (!empty($_REQUEST['deleteitems']))
		{
			...
			parent::logsDelete($context['items_list'], 'action=admin;area=shopcategories;sa=index;deleted');
		}

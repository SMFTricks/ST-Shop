 ...
 * @return
 */
function Shop_adminAreas(&$admin_areas)
{
	...
	// Permissions
	add_integration_function('integrate_load_permissions', 'Shop_adminPerms', false);
	add_integration_function('integrate_load_illegal_guest_permissions', 'Shop_adminIllegalPerms', false);
	// Boards settings
	add_integration_function('integrate_pre_boardtree', 'Shop_preboardTree', false);
	add_integration_function('integrate_boardtree_board', 'Shop_boardTree', false);
	add_integration_function('integrate_edit_board', 'Shop_boardEdit', false);
	add_integration_function('integrate_create_board', 'Shop_boardCreate', false);
	add_integration_function('integrate_modify_board', 'Shop_boardModify', false);
}
 ...
 */
function Shop_adminPerms(&$permissionGroups, &$permissionList, &$leftPermissionGroups, &$hiddenPermissions, &$relabelPermissions)
{
	global $txt;
...
/**
 * Shop_adminIllegalPerms()
 *
 * ST Shop Illegal permissions
 * 
 */
function Shop_adminIllegalPerms()
{
	global $context;
...
function Shop_boardCreate(&$boardOptions, &$board_columns, &$board_parameters)
{
	$boardOptions += array(
...
function Shop_boardModify($id, $boardOptions, &$boardUpdates, &$boardUpdateParameters)
{
...
function Shop_categoriesItemsCount($cat)
{
	global $smcFunc;
...
function Shop_logInventory($userid, $receivers, $ids, $message, $amount = 0, $itemid = 0)
{
	global $smcFunc;

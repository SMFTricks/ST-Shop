...
function Shop_adminInventory()
{
	...
	$subactions = array(
		...
		'restock2' => 'Shop_invRestock2',
		'groupcredits' => 'Shop_invGroup',
		'groupcredits2' => 'Shop_invGroup2',
		'usercredits' => 'Shop_invCredits',
		'usercredits2' => 'Shop_invCredits2',
		'useritems' => 'Shop_invItems',
		'useritems2' => 'Shop_invItems2',
	);
...
function Shop_invItems2()
{
	...
	{
		Shop_logInventory($user_info['id'], $member_parameters['member_ids'], $member_query, '', 0, $item);

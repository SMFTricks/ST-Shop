...
function Shop_adminSettings()
{
	...
	$subactions = array(
		'general' => 'Shop_settingsGeneral',
		'credits' => 'Shop_settingsCredits',
		'permissions' => 'Shop_settingsPerms',
		'profile' => 'Shop_settingsProfile',
	);
...
function Shop_settingsSave($config_vars, $return_config, $sa, $is_perm = false)
{
...
function Shop_settingsGeneral($return_config = false)
{
	...
	Shop_settingsSave($config_vars, $return_config, 'general');
}

function Shop_settingsCredits($return_config = false)
{
	global $context, $scripturl, $sourcedir, $txt;
	...
	Shop_settingsSave($config_vars, $return_config, 'credits');
}

function Shop_settingsPerms($return_config = false)
{
	global $context, $scripturl, $sourcedir, $txt;
	...
	Shop_settingsSave($config_vars, $return_config, 'permissions', true);
}

function Shop_settingsProfile($return_config = false)
{
	global $context, $scripturl, $sourcedir, $txt;
	...
	Shop_settingsSave($config_vars, $return_config, 'profile');
}
...
function Shop_adminGames()
{
	...
	$subactions = array(
		'slots' => 'Shop_gamesSlots',
		'lucky2' => 'Shop_gamesLucky2',
		'number' => 'Shop_gamesNumber',
		'pairs' => 'Shop_gamesPairs',
		'dice' => 'Shop_gamesDice',
	);
...
function Shop_settingsSave($config_vars, $return_config, $sa)
{
...
function Shop_gamesSlots($return_config = false)
{
	...
	Shop_settingsSave($config_vars, $return_config, 'slots');
}

function Shop_gamesLucky2($return_config = false)
{
	global $context, $scripturl, $sourcedir, $txt;
	...
	Shop_settingsSave($config_vars, $return_config, 'lucky2');
}

function Shop_gamesNumber($return_config = false)
{
	global $context, $scripturl, $sourcedir, $txt;
	...
	Shop_settingsSave($config_vars, $return_config, 'number');
}

function Shop_gamesPairs($return_config = false)
{
	global $context, $scripturl, $sourcedir, $txt;
	...
	Shop_settingsSave($config_vars, $return_config, 'pairs');
}

function Shop_gamesDice($return_config = false)
{
	global $context, $scripturl, $sourcedir, $txt;
	...
	Shop_settingsSave($config_vars, $return_config, 'dice');
}